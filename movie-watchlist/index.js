...
searchBtn.addEventListener('click', function() {
    ...
    fetch(`https://www.omdbapi.com/?apikey=f273a108&s=${movieInputFormatted}`)
        .then(res => res.json())
        .then(data => {
            ...
            if (data.Response === "False"){
                ...
                let moviesHTML = ''
                data.Search.forEach(movie => moviesHTML += getMovieHTML(movie))
                    ...
                    <div class="movie-container flex">
                        ...
                        <div class="movie-info">
                            <div class="movie-header flex">
                                <p class='movie-title'>${movieObj.Title}</p>
                                ...
                                <p class='font-size-12 movie-rating'>${movieObj.imdbRating}</p>
                            </div>
                            <div class="movie-details flex">
                                <p class='font-size-12'>${movieObj.Runtime}</p>
                                <p class='font-size-12'>${movieObj.Genre}</p>
                                <div class="flex">
                            ...
                            <p class="font-size-14 movie-plot">${movieObj.Plot}</p>
                        </div>
                    </div>
                `
}
